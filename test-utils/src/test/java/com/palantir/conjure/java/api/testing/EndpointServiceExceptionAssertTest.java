...
public class EndpointServiceExceptionAssertTest {
    ...
    private static final class DummyEndpointServiceException extends EndpointServiceException {
        private DummyEndpointServiceException(
                ErrorType errorType, Throwable cause, com.palantir.logsafe.Arg<?>... args) {
    ...
    public void testSanity() {
        ...
        Assertions.assertThat(new DummyEndpointServiceException(
                        actualType, null, SafeArg.of("a", "b"), UnsafeArg.of("c", "d")))
        ...
        Assertions.assertThat(new DummyEndpointServiceException(actualType, null))
                .hasNoArgs();

        assertThatThrownBy(() -> Assertions.assertThat(new DummyEndpointServiceException(actualType, null))
        ...
        assertThatThrownBy(() -> Assertions.assertThat(
                                new DummyEndpointServiceException(actualType, null, SafeArg.of("a", "b")))
                        .hasArgs(SafeArg.of("c", "d")))
                .isInstanceOf(AssertionError.class)
                .hasMessageContaining("Expected safe args to be {c=d}, but found {a=b}");

        assertThatThrownBy(() -> Assertions.assertThat(
                                new DummyEndpointServiceException(actualType, null, UnsafeArg.of("a", "b")))
        ...
        assertThatThrownBy(() -> Assertions.assertThat(new DummyEndpointServiceException(
                                actualType, null, SafeArg.of("a", "b"), UnsafeArg.of("c", "d")))
                        .hasNoArgs())
                .isInstanceOf(AssertionError.class)
        ...
        Assertions.assertThat(new DummyEndpointServiceException(
                        actualType, null, UnsafeArg.of("a", "b"), UnsafeArg.of("c", "d")))
