...
import com.palantir.conjure.java.api.errors.ServiceError;
...
/**
 * Common assertion logic for {@link com.palantir.conjure.java.api.errors.ServiceException}-style exceptions.
 *
 * @param <SELF>   the "self" type of this assertion class
 * @param <ACTUAL> the type of the exception being asserted on
 */
@SuppressWarnings({"UnusedReturnValue", "checkstyle:ClassTypeParameterName"})
public abstract class AbstractServiceExceptionAssert<
                SELF extends AbstractServiceExceptionAssert<SELF, ACTUAL>,
                ACTUAL extends RuntimeException & ServiceError>
        extends AbstractThrowableAssert<SELF, ACTUAL> {

    protected AbstractServiceExceptionAssert(ACTUAL actual, Class<?> selfType) {
        super(actual, selfType);
    }

    public final SELF hasCode(ErrorType.Code code) {
        isNotNull();
        failIfNotEqual(
    ...
    public final SELF containsArgs(Arg<?>... args) {
        isNotNull();
