...
public final class ServiceConfigurationFactoryTests {
    ...
    public void serDe() throws Exception {
        ...
        String camelCase = "{\"apiToken\":\"bearerToken\",\"security\":"
                ...
                + "{\"hostAndPort\":\"host:80\",\"credentials\":null,\"type\":\"HTTP\"},"
                + "\"connectTimeout\":\"1 day\",\"readTimeout\":\"1 day\","
                + "\"writeTimeout\":\"1 day\",\"backoffSlotSize\":\"1 day\","
        ...
        String kebabCase = "{\"api-token\":\"bearerToken\",\"security\":"
                ...
                + "\"fallback-to-common-name-verification\":null,\"queue-timeout\":null,"
