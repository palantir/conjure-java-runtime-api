...
package com.palantir.remoting.api.clients;
...
public final class UserAgentsTest {
    ...
    public void testGetUserAgent_format() {
        assertThat(UserAgents.getUserAgent("name", "version")).isEqualTo("name (version)");
    }

    @Test
    @SuppressWarnings("deprecation")
    public void testGetUserAgent_fromExternalVersionTestJar() throws IOException {
        assertThat(UserAgents.fromClass(VersionTest.class)).isEqualTo(EXPECTED_VERSION);
    }

    @Test
    public void testGetUserAgentLiberal_fromExternalVersionTestJar() {
        assertThat(UserAgents.fromClass(VersionTest.class, "fail", "fail")).isEqualTo(EXPECTED_VERSION);
    }

    @Test
    public void testGetUserAgentLiberal_fromThisClass() {
        assertThat(UserAgents.fromClass(this.getClass(), "pass-name", "pass-version")).isEqualTo(
                "pass-name (pass-version)");
    }

    @SuppressWarnings("deprecation")
    @Test
    public void testGetUserAgentStrict_fromExternalVersionTestJar() {
        assertThat(UserAgents.fromClassStrict(VersionTest.class)).isEqualTo(EXPECTED_VERSION);
    }
